// Generated from /home/tiago/github/UA-LECI/3ano/2semestre/C/P/Estudo_Exame/ex8/Calculator.g4 by ANTLR 4.13.1
...
public class CalculatorParser extends Parser {
	...
	public static final int
		RULE_main = 0, RULE_stat = 1, RULE_assigment = 2, RULE_expr = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"main", "stat", "assigment", "expr"
		};
	}
	...
	public final AssigmentContext assigment() throws RecognitionException {
		...
		try {
			...
			match(T__0);
			setState(28);
			((AssigmentContext)_localctx).e = expr(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case T__2:
				...
				setState(32);
				((ExprUnaryContext)_localctx).e = expr(6);
				}
				break;
			case INTEGER:
				{
