...
public class JGalo2 extends JFrame implements ActionListener {
	private static final long serialVersionUID = -3780928537820216588L;
	private JPanel jPanel = null;
	private JToggleButton bt[];
	JGaloInterface jogo ; 

	public JGalo2(JGaloInterface myGreatGame) {
	...
	public static void main(String args[]) {	
		if (args.length != 0) {
			new JGalo2(new JogoGalo(args[0]));
		} else {
			new JGalo2(new JogoGalo());
		}		
	}
} 